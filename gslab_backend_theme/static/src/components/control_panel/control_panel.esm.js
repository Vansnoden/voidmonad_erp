...
import {deviceContext} from "@gslab_backend_theme/components/ui_context.esm";
...
patch(LegacyControlPanel.prototype, "gslab_backend_theme.LegacyControlPanelMobile", {
    setup() {
        this._super();
        this.state = useState({
...
patch(ControlPanel.prototype, "gslab_backend_theme.ControlPanelMobile", {
    setup() {
        this._super();
        this.state = useState({
            mobileSearchMode: "",
...
patch(SearchBar, "gslab_backend_theme.SearchBarMobile", {
    template: "gslab_backend_theme.SearchBar",
});
